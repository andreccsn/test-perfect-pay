...
use App\Application\DTO\BankSlipPaymentResponseDTO;
...
class BankSlipPaymentProcessor implements PaymentProcessorInterface
{
    ...
    public function processPayment(PaymentData $payment): GatewayPaymentResponseInterface
    {
        ...
        return BankSlipPaymentResponseDTO::fromArray($paymentResponse);
    }
}
